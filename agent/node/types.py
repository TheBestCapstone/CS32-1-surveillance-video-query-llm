...
class InputValidator:
    ...
    def extract_latest_query(state: AgentState) -> str:
        """
        Safely and reliably extract the latest user query from the state.
        Rules:
        1. Always prioritize extracting from the last HumanMessage in the messages list to prevent historical state pollution.
        2. If there are no messages, fall back to using state.get("user_query").
